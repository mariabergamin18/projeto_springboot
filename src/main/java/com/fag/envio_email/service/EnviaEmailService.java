package com.fag.envio_email.service;
...
public class EnviaEmailService {
	...
	private static final Logger log = Logger.getLogger(EnviaEmailService.class);
    ...
    public void enviarEmailComAnexo(String para, String titulo, String conteudo, String arquivo) throws MessagingException, jakarta.mail.MessagingException {
